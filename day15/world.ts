...
export class World {
    constructor(public entities: Entity[], public map: Array2d<MapNode>, public directionOrder: Direction[]) { }
    ...
    public render() {
        ...
        console.log(result);
        console.log(EntityType.Goblin, this.entities.filter((e) => e.type === EntityType.Goblin).map((e) => e.HP).join(', '));
        console.log(EntityType.Elf, this.entities.filter((e) => e.type === EntityType.Elf).map((e) => e.HP).join(', '));
    }
}